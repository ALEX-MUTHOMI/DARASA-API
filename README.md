...
| [`docs/CCT_NATIONAL_COVERAGE_PLAN.md`](docs/CCT_NATIONAL_COVERAGE_PLAN.md) | How CCT stops depending on any one school's upload diligence — multi-channel evidence intake, crowd corroboration, and scoped fan-out |
